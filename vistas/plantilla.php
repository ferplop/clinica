									...
									<div class="row mt-3">
										<div class="col-md-4">
											<div class="form-group form-group-default">
												<label>DNI</label>
												<input type="text" class="form-control" value="" name="dnipa" placeholder="DNI" placeholder="77764664">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group form-group-default">
												<label>Nombres</label>
												<input type="email" class="form-control" value="" name="nombrep" placeholder="Nombre" >
											</div>
										</div>
									</div>
									<div class="row mt-3">
										<div class="col-md-4">
											<div class="form-group form-group-default">
												...
												<input type="text" class="form-control" value="" name="apellidop"  placeholder="Apellido">
											</div>
										</div>
										<div class="col-md-4">
											<div class="form-group form-group-default">
										...
										<div class="col-md-4">
											<div class="form-group form-group-default">
												<label>Sexo</label>
												<select class="form-control" value="" name="sexo" id="sexo">
													<option value=""></option>
										...
										<div class="col-md-4">
											<div class="form-group form-group-default">
												...
												<input type="text" class="form-control" value="" name="tele" placeholder="Phone">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group form-group-default">
								...
								<div class="card-header" style="background-image: url('../assets/img/blogpost.jpg')">
									<div class="profile-picture">
										<div class="avatar avatar-xl">
											<img src="vistas/assets/img/avatar.png" alt="..." class="avatar-img rounded-circle">
										</div>
									</div>
								</div>
								<div class="card-body">
